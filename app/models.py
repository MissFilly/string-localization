...
class String(models.Model):
    ...
    android_name_string = models.CharField(max_length=80, null=True, blank=True)
    ios_name_string = models.CharField(max_length=80, null=True, blank=True)
    wp_name_string = models.CharField(max_length=80, null=True, blank=True)
    osx_name_string = models.CharField(max_length=80, null=True, blank=True)
    w8_name_string = models.CharField(max_length=80, null=True, blank=True)
